...
<body>
    ...
    <div class="container">
        ...
        <form action="updated/{{ $users->id}}" method="post" class="row g-3" onsubmit="return validate()">
            @csrf
            <div class="col-md-6">
                <label for="firstname" class="form-label">First Name</label>
                <input type="text" class="form-control" name="firstname" id="firstname" value="{{$users->firstname}}" readonly>
                <span id="errorfirstname"></span>
            </div>
            <div class="col-md-6">
                <label for="lastname" class="form-label">Last Name</label>
                <input type="text" class="form-control" name="lastname" id="lastname" value="{{$users->lastname}}" readonly>
                <span id="errorlastname"></span>
            </div>
            <div class="col-md-6">
                <label for="date" class="form-label">Birthday</label>
                <input type="date" class="form-control" name="date" id="date" value="{{$users->birthday}}" readonly>
            ...
            <div class="col-md-6">
                ...
                <div>
                    ...
                    <input type="radio" name="gender" id="male" class="form-check-input" value="male"  disabled  {{ $users->gender == 'male' ? 'checked' : '' }}>
                    <label for="male" class="form-check-label">Male</label>
                    <input type="radio" name="gender" id="female" class="form-check-input ms-3" valu="female" disabled {{ $users->gender == 'female' ? 'checked' : '' }} >
            ...
            <div class="col-md-6">
                ...
                <input type="password" name="confirmpassword" id="confirmpassword" class="form-control" value="{{$users->password}}">
